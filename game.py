...
player2.capture(chess_table, 3, 4, 4, 3)
player1.move(chess_table, 4, 4, 3, 4)
player2.move(chess_table, 0, 3, 1, 4)
player2.move(chess_table, 1, 5, 3, 5)
player1.move(chess_table, 7, 5, 6, 4)
player1.step_capture(chess_table, 3, 4, 2, 5)
system('cls')
print()
print()
player1.move(chess_table, 6, 4, 5, 3)
